...
- Explored **frontend vs backend** concepts  
- Practiced **tables, paragraphs, images**  
- **Task:** Build a timetable using HTML  

---

### 🗓 Oct 10 – HTML Block & Inline Elements  
- Learned **inline vs block** behavior  
- Worked with **forms, dropdowns, and lists**  
- **Task:** Demonstrate block, inline, and inline-block usage  

---

### 🗓 Oct 13 – Introduction to CSS  
- Explored **types of CSS:** inline, internal, and external  
- Practiced **selectors, margins, and padding**  
- **Task:** Style a webpage layout  

---

### 🗓 Oct 16 – Flexbox & Grid Layouts  
- Implemented **alignment, wrapping, and justification**  
- Designed **responsive layouts**  
- **Task:** Build a **Calculator UI** using CSS Grid  

---

### 🗓 Oct 30 – CSS Box Model  
- Revised **margins, borders, shadows, and gradients**  
...
- Explored **containers, grid system, and typography**  
